...
public class DomApartmentRepository : GenericRepository<DomApartment>, IDomApartmentRepository
{
    public DomApartmentRepository(AppDbContext context) : base(context) { }

    public async Task<IEnumerable<DomApartment>> GetBySellerIdAsync(string sellerId)
