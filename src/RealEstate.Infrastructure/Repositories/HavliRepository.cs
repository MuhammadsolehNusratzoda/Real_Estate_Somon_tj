...
public class HavliRepository : GenericRepository<Havli>, IHavliRepository
{
    public HavliRepository(AppDbContext context) : base(context) { }

    public async Task<IEnumerable<Havli>> GetBySellerIdAsync(string sellerId)
